        ...
        <div class="row">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-5">
                                    <div class="post-image">
                                        <a href="{{ url('/beritabaca', $brt->slug) }}">
                                            @if ($brt->gambar != '')
                                ...
                                <div class="col-lg-7">
                                    <div class="post-content">
                                        <h2 class="font-weight-semibold pt-4 pt-lg-0 text-5 line-height-4 mb-2">
                                            <a href="{{ url('/beritabaca', $brt->slug) }}" class="tautanku1">{{ $brt->judul }}</a>
                                        </h2>
                                        <div class="post-meta lineheight-15">
                                            ...
                                            <span><a href="#" class="tautanku2"><i class="far fa-folder"></i> {{ $brt->kategori_berita }}</a> </span>
                                        </div>
            ...
            <div class="col-lg-3 order-lg-2">
                <aside class="sidebar">
                    ...
                    <a href="{{ url('/publikasi') }}" style="text-decoration: none;">
                        <h5>Publikasi</h5>
                    </a>
