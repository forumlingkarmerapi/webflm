        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <select class="form-control" id="id_user_level" name="id_user_level" style="width: 50%;">
                        @if ($kategori->count() != 0)
                            @foreach ($kategori->get() as $kat)
                                ...
                                <option value="{{ $kat->id_user_level }}" selected>{{ strtoupper($kat->level) }}</option>
                                @else
                ...
                <div class="form-group mb-1">
                    ...
                    <input type="input" class="form-control form-control-sm" value="{{ $data->username }}" id="username" name="username" style="width: 100%;">
                    <input type="hidden" class="form-control form-control-sm" value="{{ $data->id }}" id="id_pengguna" name="id_pengguna" style="width: 100%;">
                </div>
                <div class="form-group mb-1">
                    <label class="labelku" style="color: #626365;font-size:13px;"><b>Nama lengkap:</b></label>
                    <input type="input" class="form-control form-control-sm" value="{{ $data->name }}" id="name" name="name" style="width: 100%;">
                </div>
                <div class="form-group mb-1">
                ...
                <div class="form-group mb-1">
                    <label class="labelku" style="color: #626365;font-size:13px;"><b>Password:</b></label>
                    <input type="password" class="form-control form-control-sm" id="password" name="password" style="width: 60%;">
                </div>
                <div class="form-group mb-1">
                    <label class="labelku" style="color: #626365;font-size:13px;"><b>Password konfirmasi:</b></label>
                    <input type="password" class="form-control form-control-sm" id="password_konfirm" name="password_konfirm" style="width: 60%;">
                </div>
