    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group mb-1">
	            ...
	            <input type="input" class="form-control form-control-sm" id="username" name="username" style="width: 100%;">
            </div>
            <div class="form-group mb-1">
                <label class="labelku" style="color: #626365;font-size:13px;"><b>Nama lengkap:</b></label>
	            <input type="input" class="form-control form-control-sm" id="name" name="name" style="width: 100%;">
            </div>
            <div class="form-group mb-1">
                <label class="labelku" style="color: #626365;font-size:13px;"><b>Email:</b></label>
	            <input type="input" class="form-control form-control-sm" id="email" name="email" style="width: 100%;">
            </div>
            <div class="form-group mb-1">
