...
<script type="text/javascript">
    ...
    $(function (){
        var table = $('#tabelku').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ url('dap/publikasi/getlist') }}",
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'judulpublikasi', name: 'judulpublikasi'},
                {data: 'kategori', name: 'kategori'},
                {data: 'tanggalposting', name: 'tanggalposting'},
                {data: 'filedownload', name: 'filedownload'},
    ...
    function showFormadd(){
    	$('#modalku').modal('show').find('#modalku_content').load("{{ url('/dap/publikasi/add') }}");
	}
	function showFormedit(id){
		$('#modalku').modal('show').find('#modalku_content').load("{{ url('/dap/publikasi/edit') }}?id="+id);
	}
