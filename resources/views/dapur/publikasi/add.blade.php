        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group mb-1">
                    ...
                    <input type="input" class="form-control form-control-sm" id="judul_publikasi" name="judul_publikasi" style="width: 100%;">
                </div>
                <div class="form-group mb-1">
                    <label class="labelku" style="color: #626365;font-size:13px;"><b>Judul publikasi (EN):</b></label>
                    <input type="input" class="form-control form-control-sm" id="judul_publikasi_en" name="judul_publikasi_en" style="width: 100%;">
                </div>
                <div class="form-group mb-1">
